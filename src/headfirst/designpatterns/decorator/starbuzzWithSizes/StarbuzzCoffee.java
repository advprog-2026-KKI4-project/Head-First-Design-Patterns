...
public class StarbuzzCoffee {
	...
	public static void main(String args[]) {
		...
		beverage4 = new DiscountDecorator(beverage4);
		beverage4 = new ServiceTaxDecorator(beverage4);
		...
		beverage5 = new ServiceTaxDecorator(beverage5);
		beverage5 = new DiscountDecorator(beverage5);
